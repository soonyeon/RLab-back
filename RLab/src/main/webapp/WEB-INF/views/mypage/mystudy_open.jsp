			            ...
			            <div class="study_card_container">			                  	
		                    ...
		                    <div class="tab-content ing_study_ul show">
		                      ...
		                      <div class="content_box">
			                      <c:if test="${myOpenList.size() != 0 }">	
			                      	<c:forEach begin="0" end="${myOpenList.size()-1}" step="3" var="i">	                         
										                              ...
										                              <div class ="ing_study_container">
										                                <div class="study_info2">
										                                    ...
										                                    <c:if test="${myOpenList.get(index).st_image != null}">
										                                   		<div class="ing_study_img" >
											                                    	<img  
											                                    	src="<c:url value='/download/study/${myOpenList.get(index).st_image}'></c:url>" width="auto" height="172">
										                                    	</div>
										                                    </c:if>
										                                    <div class = "ing_study">
										                                      <div class="ing_study_title">${myOpenList.get(index).st_name}</div>
										                                      <div class="ing_study_title2">${myOpenList.get(index).st_info}</div>
										                                    </div>
