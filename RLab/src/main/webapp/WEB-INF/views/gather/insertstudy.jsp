...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <link rel="stylesheet" href="<c:url value='/resources/css/gather/insertstudy.css'></c:url>">
              ...
              <div class="temporary_storage_box"> 
                ...
                <div class="top_box">
                  ...
                  <div class="ns_finish_date_box">
                    <h3>완료날짜</h3>
                    <li class="yes_finish">적용</li><li class="no_finish">미적용</li>
                    <input type="date" class="datepicker">
								...
								<div class="ns_tag_box">
									<input type="text" class="ns_tag" placeholder="예시. #정처기, #모각코, #프로젝트 (태그명 최대 10자까지)">
								</div>
								<h3>소개글</h3>
								<div class="ns_introduce_box">
                  <input type="text" class="ns_introduce" placeholder="100자 이내로 스터디를 소개해보세요"> 
								</div>
							</form>
              <div class="btn_box">
